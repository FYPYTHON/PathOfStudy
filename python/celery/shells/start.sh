...
# 启动multi: celery multi start w1 -A  CeleryPro -l info
...
PYTHONPATH=${chdir_path}/lib/python3.8/site-packages ${chdir_path}/bin/celery multi start worker ${cargs} >> ${chdir_path}/log.log 2>&1
