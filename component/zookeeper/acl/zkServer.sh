...
# acl 20221225
root_pwd=`echo "WmtfMjAyMiFfMjU="|base64 -d`
root_info=$(echo -n "root:${root_pwd}" | openssl dgst -binary -sha1 | openssl base64)
SERVER_JVMFLAGS="-Dzookeeper.DigestAuthenticationProvider.superDigest=root:${root_info}"
